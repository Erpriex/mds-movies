...
export const PointIcon = ({width = 6, height = 6, stroke = 'white'}) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 7 6" fill="none">
      <Circle id="Ellipse 1" cx="3.5" cy="3" r="3" fill={stroke} />
    </Svg>
  );
};

export const StarIcon = ({width = 12, height = 12, stroke = 'white'}) => {
  return (
    <Svg width={width} height={height} id="Capa_1" viewBox="0 0 47.94 47.94">
      <Path
        fill={stroke}
